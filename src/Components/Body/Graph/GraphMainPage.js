        ...
        <GraphMainPageMainDivBox>
                    ...
                    <div className="Show_Info_Container">
                        ...
                        <div className="Show_Grade_Container">
                            <ul>
                                <li>
                                    CDC :{' '}
                                    {Csm_Grade_Count_State?.Grinder_Grade_Count_Data?.reduce((accumulator, currentValue) => {
                                        return currentValue.csm_basic_data_grade === 'CDC'
                                ...
                                <li>
                                    SDC :{' '}
                                    {Csm_Grade_Count_State?.Grinder_Grade_Count_Data?.reduce((accumulator, currentValue) => {
                                        return currentValue.csm_basic_data_grade === 'SDC'
                                            ? accumulator + currentValue.count
                                            : accumulator + 0;
                                    }, 0)}{' '}
                                    건
                                ...
                                <li>
                                    MDC :{' '}
                                    {Csm_Grade_Count_State?.Grinder_Grade_Count_Data?.reduce((accumulator, currentValue) => {
                                        return currentValue.csm_basic_data_grade === 'MDC'
                                            ? accumulator + currentValue.count
                                            : accumulator + 0;
                                    }, 0)}{' '}
                                    건
                    ...
                    <div className="Show_Info_Container">
                        ...
                        <div className="Show_Grade_Container">
                            <ul>
                                <li>
                                    CDC :{' '}
                                    {Csm_Grade_Count_State?.Dicer_Grade_Count_Data?.reduce((accumulator, currentValue) => {
                                        return currentValue.csm_basic_data_grade === 'CDC'
                                            ? accumulator + currentValue.count
                                            : accumulator + 0;
                                    }, 0)}{' '}
                    ...
                    <div className="Show_Info_Container">
                        ...
                        <div className="Show_Grade_Container">
                            <ul>
                                <li>
                                    CDC :{' '}
                                    {Csm_Grade_Count_State?.Laser_Grade_Count_Data?.reduce((accumulator, currentValue) => {
                                        return currentValue.csm_basic_data_grade === 'CDC'
                                            ? accumulator + currentValue.count
                                            : accumulator + 0;
                                    }, 0)}{' '}
            ...
            <div className="Show_ALL_Grade_Container">
                <ul>
                    <li>
                        CDC :{' '}
                        {Csm_Grade_Count_State?.All_Grade_Count_Data?.reduce((accumulator, currentValue) => {
