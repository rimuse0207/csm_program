...
const FilterPartNumber = ({Close_Filter_Modal,SelectMenuTitle}) => {
    ...
    const handleClick_Filter_State = (Select) => {
        dispatch(Csm_Filtering_Change_Data({ ...Csm_Filter_States, csm_basic_data_part_number: Select }))
        Close_Filter_Modal();
    }
        ...
        <FilterStateMainDivBox>
            ...
            <div>
                ...
                <div className="List_Data_Container">
                    <h4>Part Number List</h4>
                    <ul>
                        {List_Csm_State_Data.map((list) => {
                            return <li>
                                <div onClick={()=>handleClick_Filter_State(list.csm_basic_data_part_number)}>
                                    {list.csm_basic_data_part_number}
                                </div>
                            </li>
                        })}
                    </ul>
...
export default FilterPartNumber;