                        ...
                        return <ul className={`Table_Body ${list.checked === "false" || list.checked === false ? "" : "Checking_Background"}`} key={list.csm_basic_data_csm_key} style={list.checked === "false" || list.checked === false ? RightMenuClickKeys?.csm_basic_data_csm_key ? RightMenuClickKeys?.csm_basic_data_csm_key === list.csm_basic_data_csm_key ? {}:{opacity:'0.2'}:{} : { border: "1px solid #368" }}
                            ...
                            <div className="Main_Body_Fixed_Container">
                                <li style={{display:"flex",alignItems:"center",width:"100px"}}>
                                    <div style={{ background: `${Border_Color_Checking(list)}`, width: "5px",height:"40px",marginRight:"10px",borderRadius:"10px"}}></div>
                             ...
                             <div className="Sub_Body_Fixed_Container">
                                ...
                                <li>
                                    { list?.csm_user_input_data_travel_range_cost?"￥"+list?.csm_user_input_data_travel_range_cost.toString()
                                                                        .replace(/\B(?=(\d{3})+(?!\d))/g, ','):""}
                                </li>
                                <li>
                                    { list?.csm_user_input_data_travel_time_cost?"￥"+list?.csm_user_input_data_travel_time_cost.toString()
                                                                        .replace(/\B(?=(\d{3})+(?!\d))/g, ','):""}
                                </li>
                                <li>
                                    { list?.csm_user_input_data_stay_days_cost? "￥"+list?.csm_user_input_data_stay_days_cost.toString()
                                                                        .replace(/\B(?=(\d{3})+(?!\d))/g, ','):""}
                                </li>
                                <li>
                                    { list?.csm_user_input_data_operation_cost?"￥"+list?.csm_user_input_data_operation_cost.toString()
                                                                        .replace(/\B(?=(\d{3})+(?!\d))/g, ','):""}
                                </li>
                                <li>
                                    { list?.csm_user_input_data_total_cost?"￥"+list?.csm_user_input_data_total_cost.toString()
                                                                        .replace(/\B(?=(\d{3})+(?!\d))/g, ','):""}
                                </li>
                                <li style={{borderLeft: "1px solid lightgray"}}>
                                {/* 발행 */}
